    ...
    <section class="filter">
        ...
        <nav>
            <div class="nav-wrapper"> 
                <div class="ms-3">
                    {{ Breadcrumbs::render('main.guest.filter.buyOrTrade') }}     
                </div>    
                ...
                <div class="ms-4 mt-2">
                    ...
                    <a href="{{ route('main.guest.filter.buyOrTrade') }}">
                        <i class="fa-solid fa-filter ms-2"></i>
                        <span class="" style="color: #EA3C77;"> Pirkti arba mainyti </span>
                    </a>
                </div>
                <div class="mt-2 ms-3">
                                ...
                                <div class="col-md-6 mt-1">
                                    ...
                                    <div class="mt-1 mb-1 spec-1">
                                        @foreach ($listing->products as $product)
                                            <span class="fw-bold">{{ $product->category->category_name }} |
                                            </span>
                                        @endforeach
                                    </div>
                                    <div class="d-flex flex-row">
                                        <p class="text-justify para text-wrap mt-1">
