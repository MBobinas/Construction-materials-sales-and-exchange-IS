...
<body>
    ...
    <div class="container mt-2 mb-2">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <form action="{{route('user.activeTrade.transportationOrder.afterpayment')}}" method="post" id="payment-form" onsubmit="return submitForm(this);">
                        @csrf
                        ...
                        <input type="hidden" name="receiver_address" id="receiver_address" value="{{ $receiver_address }}" />
