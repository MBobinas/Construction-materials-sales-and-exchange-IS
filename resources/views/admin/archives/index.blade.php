        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item my-auto">
                    {{ Breadcrumbs::render('admin.archives.index') }}
                </li>               
            </ol>
            @if (session('success'))
        ...
        <div class="container-fluid mt-3">
            <div class="col-md-11 text-center">
                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{{ route('admin.archives.index') }}" class="btn btn-outline-primary active"
                        aria-current="page">Archyvuoti skelbimai</a>
                    <a href="{{ route('admin.archives.orders') }}" class="btn btn-outline-primary">Archyvuoti sandoriai</a>
                </div>
            </div>
                    ...
                    @foreach ($listings as $listing)
                        <div class="row p-2 bg-white border rounded">
                            ...
                            <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                                ...
                                <form action ="{{ route('admin.listings.destroy', $listing->id) }}" method="POST" onsubmit="return submitForm(this);">
                                    @csrf
                                    @method('DELETE')
