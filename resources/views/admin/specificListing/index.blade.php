...
@section('content')
    ...
    <body>
        {{ Breadcrumbs::render('admin.specificListing.index', $listing) }}
        @if (session('error'))
                ...
                <div class="col-sm-7 border border-dark rounded" style="background-color: #DBE0E7">
                    ...
                    <div class="col-sm-12">
                        @if ($listing->listing_type == 'parduoti' || $listing->listing_type == 'parduoti arba mainyti')
                            <form action="{{ route('user.listings.checkout', $listing->id) }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                <div class="card">
                                                            ...
                                                            <div class="border-bottom">
                                                                <div
                                                                    ...
                                                                    <a href="/skelbimas/{{ $listing->id }}/komentaras/{{ $comment->id }}"
                                                                        title="Pašalinti"><i class="fa-light fa-x"></i></a>
